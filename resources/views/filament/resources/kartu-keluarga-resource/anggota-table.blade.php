    ...
    <table class="min-w-full divide-y divide-gray-200">
        <thead>
            <tr class="bg-gray-50">
                ...
                <th class="px-3 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Tanggal Lahir
                </th>
                ...
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="px-3 py-2 whitespace-nowrap text-sm text-gray-500">
                        @if ($item->jenis_kelamin === 'L')
                            <span
                                class="px-2 inline-flex text-sm leading-5 font-semibold rounded-full bg-blue-100 text-blue-800">L</span>
                        @else
                            <span
                                class="px-2 inline-flex text-sm leading-5 font-semibold rounded-full bg-pink-100 text-pink-800">P</span>
                        @endif
                    </td>
                    <td class="px-3 py-2 whitespace-nowrap text-sm text-gray-500">
