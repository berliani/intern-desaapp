...
@section('content')
        ...
        <div class="absolute inset-0 w-full h-full">
            @if (isset($profilDesa->thumbnails) && is_array($profilDesa->thumbnails) && count($profilDesa->thumbnails) > 0)
                @foreach ($profilDesa->thumbnails as $index => $thumbnail)
                    <div x-show="currentSlide === {{ $index }}" x-transition:enter="transition ease-out"
                        x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100"
                        x-transition:leave="transition ease-in" x-transition:leave-start="opacity-100"
                        x-transition:leave-end="opacity-0" :style="'transition-duration: ' + transitionDuration + 'ms'"
                        class="absolute inset-0 w-full h-full overflow-hidden">
                        <img src="{{ Storage::url($thumbnail) }}" alt="Slide {{ $index + 1 }}" loading="lazy"
                ...
                <div class="flex items-center gap-1.5">
                    @foreach ($profilDesa->thumbnails as $index => $thumbnail)
                        <button @click="currentSlide = {{ $index }}"
                            ...
                            :class="{ 'w-6 bg-white': currentSlide ===
                                {{ $index }}, 'w-3 bg-white/30 hover:bg-white/50': currentSlide !==
                                    {{ $index }} }">
                        </button>
                    @endforeach
                </div>
            ...
            <div class="absolute bottom-8 left-8 right-8 z-20 hidden md:flex">
                <div class="flex items-center gap-2">
                    @foreach ($profilDesa->thumbnails as $index => $thumbnail)
                        <button @click="currentSlide = {{ $index }}"
                            class="h-1.5 transition-all duration-300 focus:outline-none rounded-full overflow-hidden"
                            :class="{ 'w-8 bg-white': currentSlide ===
                                {{ $index }}, 'w-4 bg-white/30 hover:bg-white/50': currentSlide !==
                                    {{ $index }} }">
                        </button>
                    @endforeach
                </div>
    ...
    <section class="py-12 bg-white relative z-10 overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                <!-- Penduduk Stat -->
                <div class="bg-gradient-to-br from-white to-gray-50 rounded-2xl overflow-hidden shadow-sm hover:shadow-lg transition-all duration-500 group relative"
                    ...
                    <div class="p-6">
                        <!-- Floating Icon -->
                        <div
                            class="absolute top-6 right-6 w-16 h-16 flex items-center justify-center text-emerald-100 opacity-50 group-hover:opacity-100 group-hover:scale-125 transition-all duration-700">
                            <i class="fas fa-users text-5xl"></i>
                        </div>

                        <!-- Label -->
                        <div
                            class="inline-flex items-center px-3 py-1 rounded-full bg-emerald-50 text-emerald-700 text-xs font-medium">
                        ...
                        <div class="mt-2 mb-1">
                            <div class="text-4xl md:text-5xl font-bold text-gray-800 tracking-tight tabular-nums counter-item flex items-baseline"
                                x-data="{ shown: false, value: 0, target: {{ $statistik['penduduk'] ?? 0 }} }" x-init="$el._x_isShown = false">
                                <span x-text="value.toLocaleString()"
                                    class="group-hover:text-emerald-700 transition-colors duration-300">0</span>
                        ...
                        <p class="text-sm text-gray-500 mt-1 group-hover:text-gray-700 transition-colors duration-300">
                            Total Penduduk Desa</p>

                        <!-- Decorative Element -->
                        <div
                            class="w-12 h-1 bg-emerald-200 rounded-full mt-4 group-hover:w-20 transition-all duration-500">
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-gradient-to-br from-white to-gray-50 rounded-2xl overflow-hidden shadow-sm hover:shadow-lg transition-all duration-500 group relative"
                    ...
                    <div class="p-6">
                        <!-- Floating Icon -->
                        <div
                            class="absolute top-6 right-6 w-16 h-16 flex items-center justify-center text-blue-100 opacity-50 group-hover:opacity-100 group-hover:scale-125 transition-all duration-700">
                        ...
                        <div class="mt-2 mb-1">
                            <div class="text-4xl md:text-5xl font-bold text-gray-800 tracking-tight tabular-nums counter-item flex items-baseline"
                                x-data="{ shown: false, value: 0, target: {{ $statistik['umkm'] ?? 0 }} }" x-init="$el._x_isShown = false">
                                <span x-text="value.toLocaleString()"
                                    class="group-hover:text-blue-700 transition-colors duration-300">0</span>
                        ...
                        <!-- Decorative Element -->
                        <div class="w-12 h-1 bg-blue-200 rounded-full mt-4 group-hover:w-20 transition-all duration-500">
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-gradient-to-br from-white to-gray-50 rounded-2xl overflow-hidden shadow-sm hover:shadow-lg transition-all duration-500 group relative"
                    ...
                    <div class="p-6">
                        <!-- Floating Icon -->
                        <div
                            class="absolute top-6 right-6 w-16 h-16 flex items-center justify-center text-amber-100 opacity-50 group-hover:opacity-100 group-hover:scale-125 transition-all duration-700">
                            <i class="fas fa-newspaper text-5xl"></i>
                        </div>

                        <!-- Label -->
                        <div
                            class="inline-flex items-center px-3 py-1 rounded-full bg-amber-50 text-amber-700 text-xs font-medium">
                        ...
                        <div class="mt-2 mb-1">
                            <div class="text-4xl md:text-5xl font-bold text-gray-800 tracking-tight tabular-nums counter-item flex items-baseline"
                                x-data="{ shown: false, value: 0, target: {{ $statistik['berita'] ?? 0 }} }" x-init="$el._x_isShown = false">
                                <span x-text="value.toLocaleString()"
                                    class="group-hover:text-amber-700 transition-colors duration-300">0</span>
                        ...
                        <!-- Decorative Element -->
                        <div class="w-12 h-1 bg-amber-200 rounded-full mt-4 group-hover:w-20 transition-all duration-500">
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-gradient-to-br from-white to-gray-50 rounded-2xl overflow-hidden shadow-sm hover:shadow-lg transition-all duration-500 group relative"
                    ...
                    <div class="p-6">
                        <!-- Floating Icon -->
                        <div
                            class="absolute top-6 right-6 w-16 h-16 flex items-center justify-center text-purple-100 opacity-50 group-hover:opacity-100 group-hover:scale-125 transition-all duration-700">
                        ...
                        <div class="mt-2 mb-1">
                            <div class="text-4xl md:text-5xl font-bold text-gray-800 tracking-tight tabular-nums counter-item flex items-baseline"
                                x-data="{ shown: false, value: 0, target: {{ $statistik['layanan'] ?? 0 }} }" x-init="$el._x_isShown = false">
                                <span x-text="value.toLocaleString()"
                                    class="group-hover:text-purple-700 transition-colors duration-300">0</span>
                        ...
                        <!-- Label -->
                        <p class="text-sm text-gray-500 mt-1 group-hover:text-gray-700 transition-colors duration-300">
                            Total Layanan Desa</p>

                        <!-- Decorative Element -->
                        <div class="w-12 h-1 bg-purple-200 rounded-full mt-4 group-hover:w-20 transition-all duration-500">
                        </div>
                    </div>
                </div>
            </div>
    ...
    @if (
        ($strukturPemerintahan && $strukturPemerintahan->sambutan_kepala_desa) ||
        ...
        <section class="py-12 bg-gray-50 relative overflow-hidden">
            ...
            <div
                class="absolute top-0 right-0 w-96 h-96 bg-gradient-to-br from-emerald-100/40 to-emerald-50/10 rounded-full blur-3xl -z-10 animate-pulse">
            </div>
            <div class="absolute bottom-0 left-0 w-96 h-96 bg-gradient-to-tr from-blue-100/40 to-blue-50/10 rounded-full blur-3xl -z-10 animate-pulse"
                style="animation-delay: 2s;"></div>

            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <!-- Modern React-style Tab Interface -->
                <div x-data="{ activeTab: window.location.hash ? window.location.hash.substring(1) : 'sambutan' }" x-init="$watch('activeTab', value => { window.location.hash = value })">
                        ...
                        <div class="inline-flex bg-white/90 backdrop-blur-sm rounded-full p-1 shadow-md">
                            @if ($strukturPemerintahan && $strukturPemerintahan->sambutan_kepala_desa)
                                <button @click="activeTab = 'sambutan'"
                                    :class="{
                                        'bg-gradient-to-r from-emerald-500 to-emerald-600 text-white shadow-md': activeTab === 'sambutan',
                                    ...
                                    <svg class="w-4 h-4 mr-1.5" viewBox="0 0 24 24" fill="none"
                                        ...
                                        <path
                                            d="M8 9H16M8 13H14M8 17H12M10 2V6M14 2V6M3 8C3 6.89543 3.89543 6 5 6H19C20.1046 6 21 6.89543 21 8V20C21 21.1046 20.1046 22 19 22H5C3.89543 22 3 21.1046 3 20V8Z"
                            ...
                            @if ($strukturPemerintahan && ($strukturPemerintahan->prioritas_program || $strukturPemerintahan->program_kerja))
                                <button @click="activeTab = 'program'"
                                    :class="{
                                        'bg-gradient-to-r from-blue-500 to-blue-600 text-white shadow-md': activeTab === 'program',
                    ...
                    <div class="mt-8 relative">
                        ...
                        @if ($strukturPemerintahan && $strukturPemerintahan->sambutan_kepala_desa)
                            <div x-show="activeTab === 'sambutan'"
                                ...
                                x-transition:leave-end="opacity-0 transform -translate-y-4" class="mx-auto max-w-5xl">
                                ...
                                <div class="bg-white rounded-xl shadow-md overflow-hidden">
                                    <div class="grid md:grid-cols-12 gap-6 p-6">
                                        ...
                                        @if ($strukturPemerintahan->foto_kepala_desa)
                                            <div class="md:col-span-4 flex flex-col items-center" data-aos="fade-right">
                                                <div class="relative mb-3">
                                                    <!-- Profile Photo -->
                                                    <div
                                                        class="w-28 h-28 md:w-32 md:h-32 rounded-full overflow-hidden ring-4 ring-white shadow-md relative z-10">
                                                    ...
                                                    <!-- Verification Badge -->
                                                    <div
                                                        class="absolute -bottom-1 -right-1 w-6 h-6 bg-emerald-500 rounded-full flex items-center justify-center shadow-md z-20">
                                                ...
                                                <div class="text-center">
                                                    <h3 class="text-lg font-bold text-gray-900">
                                                        {{ $strukturPemerintahan->nama_kepala_desa }}</h3>
                                                    <p class="text-sm font-medium text-emerald-700">Kepala Desa</p>
                                                    <p class="text-xs text-gray-500 mt-1">
                                                        {{ $strukturPemerintahan->periode_jabatan }}</p>
                                                </div>
                                                ...
                                                <div class="mt-4 hidden md:flex justify-center">
                                                    <div class="flex space-x-1">
                                                        @for ($i = 0; $i < 5; $i++)
                                                            <div class="w-1.5 h-1.5 rounded-full bg-emerald-400 animate-bounce"
                                        ...
                                        <div class="md:col-span-8" data-aos="fade-left">
                                            <div
                                                class="prose prose-emerald max-w-none text-gray-600 leading-relaxed p-4 bg-white">
                            ...
                            <div x-show="activeTab === 'program'"
                                ...
                                <div class="flex flex-col md:flex-row gap-8 mb-5 md:mb-3 items-center" data-aos="fade-up">
                                    ...
                                    <div class="w-20 h-20 md:w-24 md:h-24 relative perspective-1000 hidden md:block">
                                        <div
                                            class="absolute inset-0 bg-gradient-to-br from-blue-400 to-emerald-400 rounded-xl shadow-lg animate-rotate-y">
                                        </div>
                                        <div
                                            class="absolute inset-2 bg-white rounded-lg flex items-center justify-center animate-rotate-y-reverse">
                                    ...
                                    <!-- Descriptive Text -->
                                    <p
                                        class="text-gray-600 flex-1 text-center md:text-left bg-white backdrop-blur-sm p-4 rounded-lg shadow-sm">
                                        Program yang menjadi fokus pembangunan dan pengembangan desa untuk mewujudkan
                                ...
                                <div x-data="{ activeSubTab: 'prioritas' }" data-aos="fade-up">
                                    ...
                                    <div class="flex justify-center mb-5">
                                        <div class="inline-flex bg-white/90 backdrop-blur-sm rounded-full p-1 shadow-md">
                                            <button @click="activeSubTab = 'prioritas'"
                                                :class="{
                                                    'bg-gradient-to-r from-blue-500 to-blue-600 text-white shadow-md': activeSubTab === 'prioritas',
                                                ...
                                                <svg class="w-4 h-4 mr-1.5"
                                                    :class="{ 'text-white': activeSubTab === 'prioritas' }"
                                            ...
                                            <button @click="activeSubTab = 'programKerja'"
                                                :class="{
                                                    'bg-gradient-to-r from-emerald-500 to-emerald-600 text-white shadow-md': activeSubTab === 'programKerja',
                                                    'bg-transparent text-gray-600 hover:text-gray-800': activeSubTab !== 'programKerja'
                                                }"
                                                class="px-4 py-2.5 rounded-full text-sm font-medium transition-all duration-300 flex items-center">
                                                <svg class="w-4 h-4 mr-1.5"
                                                    :class="{ 'text-white': activeSubTab === 'programKerja' }"
                                                    viewBox="0 0 20 20" fill="currentColor">
                                    ...
                                    <div class="bg-white rounded-xl shadow-md overflow-hidden">
                                        ...
                                        <div x-show="activeSubTab === 'prioritas'"
                                            ...
                                            x-transition:leave-start="opacity-100 transform translate-y-0"
                                            x-transition:leave-end="opacity-0 transform -translate-y-4" class="p-6">
                                            ...
                                            @else
                                                <div class="py-10 text-center">
                                                    ...
                                                    <h3 class="text-xl font-medium text-gray-800 mb-2">Belum Ada Program
                                                        Prioritas</h3>
                                                    <p class="text-gray-500 max-w-md mx-auto">Program prioritas pembangunan
                                                        desa belum tersedia atau sedang dalam proses pembaruan.</p>
                                                </div>
                                            @endif
                                        </div>
                                        ...
                                        <div x-show="activeSubTab === 'programKerja'"
                                            ...
                                            @else
                                                <div class="py-10 text-center">
                                                    ...
                                                    <div class="w-20 h-20 mx-auto mb-4 relative">
                                                        <div
                                                            class="absolute inset-0 rounded-full bg-emerald-100 animate-pulse">
                                                        </div>
                                                        <div class="absolute inset-0 flex items-center justify-center">
                                                            <svg class="w-10 h-10 text-emerald-400" fill="none"
                                                                viewBox="0 0 24 24" stroke="currentColor">
                                                                <path stroke-linecap="round" stroke-linejoin="round"
                                                                    stroke-width="2"
                                                    ...
                                                    <h3 class="text-xl font-medium text-gray-800 mb-2">Belum Ada Program
                                                        Kerja</h3>
                                                    <p class="text-gray-500 max-w-md mx-auto">Program kerja desa belum
                                                        tersedia atau sedang dalam proses pembaruan.</p>
                                                </div>
                                            @endif
                                        </div>
                                    </div>
                                        ...
                                        <div class="relative aspect-w-16 aspect-h-9 overflow-hidden">
                                            @if ($berita->gambar)
                                                <img class="object-cover w-full h-full transition-transform duration-700 group-hover:scale-105"
                                                    src="{{ Storage::url($berita->gambar) }}" alt="{{ $berita->judul }}"
                                                    loading="lazy">
                                            ...
                                            <div class="flex items-center justify-between mb-4 relative z-10">
                                                ...
                                                <div class="flex items-center">
                                                    <div
                                                        ...
                                                        <div
                                                            class="bg-emerald-500 text-white text-xs font-bold w-full text-center py-0.5 px-2">
                                                ...
                                                @if (isset($berita->kategori))
                                                    ...
                                                    @endphp
                                                    <span
                                                        class="inline-flex items-center px-2.5 py-1.5 rounded-md text-xs font-medium text-white {{ $styles }} shadow-md border-l-4">
                                    ...
                                    <div
                                        ...
                                        <div class="relative aspect-w-16 aspect-h-9 overflow-hidden">
                                            @if ($umkm->foto_usaha)
                                                <img class="object-cover w-full h-full transition-transform duration-700 group-hover:scale-105"
                                                    ...
                                                    alt="{{ $umkm->nama_usaha }}" loading="lazy">
                                        ...
                                        <div class="p-6 flex flex-col flex-grow relative bg-white">
                                            ...
                                            border border-{{ $kategoriColors[$umkm->kategori] ?? 'emerald' }}-100 shadow-sm">
                                                    <i
                                                        class="{{ $kategoriIcons[$umkm->kategori] ?? 'fas fa-store' }} text-{{ $kategoriColors[$umkm->kategori] ?? 'emerald' }}-500 mr-1.5"></i>
                                                    {{ $umkm->kategori }}
                                                </span>

                                                <!-- Right: UMKM Verification Badge -->
                                                <div
                                                    class="flex items-center text-xs font-medium px-2.5 py-1.5 rounded-md border border-blue-100 bg-blue-50 text-blue-700">
                                            ...
                                            <a href="{{ route('umkm.show', $umkm->id) }}"
                                                ...
                                                <h3
                                                    class="text-xl font-bold text-gray-900 leading-tight mb-2 line-clamp-2 group-hover:text-emerald-600 transition-colors">
                                                    {{ $umkm->nama_usaha }}
                                                </h3>
                                            </a>
                                            ...
                                            <div
                                                ...
                                                <a href="{{ $umkm->getWhatsappUrl() }}" target="_blank"
                                                ...
                                                <a href="{{ route('umkm.show', $umkm->id) }}"
                                                    class="inline-flex items-center text-emerald-600 font-medium text-sm transition-colors duration-300 group/detail hover:text-emerald-700">
                                                    <span class="relative">
                                                        <span
                                                            class="absolute bottom-0 h-0.5 w-full scale-x-0 origin-left bg-emerald-600 transition-transform duration-300 group-hover/detail:scale-x-100"></span>
                                                        Lihat detail
                                                    </span>
                                                    <svg class="ml-1.5 w-4 h-4 transform transition-transform duration-300 group-hover/detail:translate-x-1"
                                                        fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                        <path stroke-linecap="round" stroke-linejoin="round"
                                                            stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6" />
                                                    </svg>
    ...
    <section class="pt-12 pb-20 bg-gradient-to-br from-emerald-600 to-emerald-900 relative overflow-hidden">
        ...
        <div class="absolute bottom-0 right-0 w-96 h-96 bg-white opacity-5 rounded-full translate-x-1/3 translate-y-1/3">
        </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="text-center">
                <!-- Badge -->
                <div class="relative inline-flex items-center px-4 py-2 rounded-full bg-gradient-to-r from-emerald-600/30 to-emerald-700/30 backdrop-blur-lg border border-white/30 shadow-xl group overflow-hidden"
                    data-aos="fade-down">
                    <!-- Moving Light Effect -->
                    <span
                ...
                <div class="mt-8 flex flex-col px-12 sm:flex-row gap-4 justify-center">
                    <a href="{{ route('layanan') }}"
                        class="inline-flex items-center justify-center px-3 py-3 text-base font-medium rounded-lg bg-white text-emerald-700 hover:bg-gray-100 shadow-lg hover:shadow-xl transition-all duration-300">
                        <i class="fas fa-file-alt mr-2"></i> Lihat Layanan Desa
                    </a>

                    <a href="{{ route('profil') }}"
                        class="inline-flex items-center justify-center px-3 py-3 text-base font-medium rounded-lg bg-emerald-500 text-white hover:bg-emerald-600 shadow-lg hover:shadow-xl transition-all duration-300">
    ...
    <section class="py-12 bg-white relative overflow-hidden">
        ...
        <div
            class="absolute top-0 right-0 w-1/2 h-1/2 bg-gradient-to-br from-emerald-50 to-emerald-100/20 rounded-full opacity-60 blur-3xl -z-10 transform translate-x-1/4 -translate-y-1/4">
        </div>
        <div
            class="absolute bottom-0 left-0 w-1/2 h-1/2 bg-gradient-to-tr from-blue-50 to-blue-100/20 rounded-full opacity-60 blur-3xl -z-10 transform -translate-x-1/4 translate-y-1/4">
        </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
                        ...
                        <div class="bg-gray-50 p-5 border-b border-gray-100 relative z-10">
                            <div class="flex items-center">
                                <div class="flex-shrink-0 mr-4">
                                    <div
                                        class="w-12 h-12 rounded-lg bg-emerald-500 flex items-center justify-center shadow-md">
                        ...
                        <div class="relative">
                            ...
                            <div class="absolute inset-0 bg-gray-100 flex items-center justify-center z-10 map-loader">
                                <div class="flex flex-col items-center">
                                    <div class="animate-spin rounded-full h-10 w-10 border-b-2 border-emerald-500 mb-2">
                                    </div>
                ...
                <div class="lg:col-span-5 order-1 lg:order-2 flex flex-col gap-5" data-aos="fade-left">
                    ...
                    <div
                        class="bg-gray-50 p-6 rounded-2xl shadow-lg transition-all duration-300 hover:shadow-xl border border-gray-100 hover:border-blue-200 group">
                        <div class="flex items-start">
                            <div class="flex-shrink-0 mr-5">
                                <div
                                    class="w-14 h-14 rounded-xl bg-gradient-to-br from-blue-400 to-blue-600 flex items-center justify-center shadow-md group-hover:scale-110 transition-transform duration-300">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600 mt-3 group-hover:text-gray-700 transition-colors">
                                    @if ($profilDesa->telepon)
                                        <a href="tel:{{ $profilDesa->telepon }}"
                                            class="hover:text-blue-600 transition-colors flex items-center">
                                            <span>{{ $profilDesa->telepon }}</span>
                                            <span
                                                class="ml-2 text-blue-500 opacity-0 group-hover:opacity-100 transition-opacity">
                    ...
                    <div
                        class="bg-gray-50 p-6 rounded-2xl shadow-lg transition-all duration-300 hover:shadow-xl border border-gray-100 hover:border-purple-200 group">
                        <div class="flex items-start">
                            <div class="flex-shrink-0 mr-5">
                                <div
                                    class="w-14 h-14 rounded-xl bg-gradient-to-br from-purple-400 to-purple-600 flex items-center justify-center shadow-md group-hover:scale-110 transition-transform duration-300">
                                    <i class="fas fa-envelope text-white text-xl"></i>
                                </div>
                            </div>
                            <div>
                                <h4
                                    class="text-lg font-semibold text-gray-900 group-hover:text-purple-700 transition-colors">
                                    Email</h4>
                                <p class="text-gray-600 mt-3 group-hover:text-gray-700 transition-colors">
                                    @if ($profilDesa->email)
                                        <a href="mailto:{{ $profilDesa->email }}"
                                            class="hover:text-purple-600 transition-colors flex items-center">
                                            <span class="break-all">{{ $profilDesa->email }}</span>
                                            <span
                                                class="ml-2 text-purple-500 opacity-0 group-hover:opacity-100 transition-opacity">
                                                <i class="fas fa-arrow-right text-xs"></i>
                                            </span>
                                        </a>
                                    @else
                    ...
                    <div
                        class="bg-gray-50 p-6 rounded-2xl shadow-lg transition-all duration-300 hover:shadow-xl border border-gray-100 hover:border-amber-200 group">
                        <div class="flex items-start">
                            <div class="flex-shrink-0 mr-5">
                                <div
                                    class="w-14 h-14 rounded-xl bg-gradient-to-br from-amber-400 to-amber-600 flex items-center justify-center shadow-md group-hover:scale-110 transition-transform duration-300">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600 mt-3 group-hover:text-gray-700 transition-colors">
                                    @if ($profilDesa->website)
                                        <a href="{{ $profilDesa->website }}" target="_blank"
                                            class="hover:text-amber-600 transition-colors flex items-center">
                                            <span class="break-all">{{ $profilDesa->website }}</span>
                                            <span
                                                class="ml-2 text-amber-500 opacity-0 group-hover:opacity-100 transition-opacity">
